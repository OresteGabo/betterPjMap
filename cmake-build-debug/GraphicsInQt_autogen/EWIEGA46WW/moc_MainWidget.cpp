...
template <> constexpr inline auto MainWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'carAdded'
        QtMocHelpers::SignalData<void(Car *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'clearDebugText'
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->carAdded((*reinterpret_cast< std::add_pointer_t<Car*>>(_a[1]))); break;
        ...
        case 6: _t->sliderValueChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MainWidget::*)(Car * )>(_a, &MainWidget::carAdded, 0))
            return;
    }
}
