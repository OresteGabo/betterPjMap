...
QT_MOC_LITERAL(1, 4, 10), // "carClicked"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 16), // "reachedEndOfPath"
QT_MOC_LITERAL(4, 33, 10) // "lastNodeId"

    },
    "Car\0carClicked\0\0reachedEndOfPath\0"
    "lastNodeId"
};
...
void Car::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->carClicked(); break;
        case 1: _t->reachedEndOfPath((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Car::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Car::carClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Car::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Car::reachedEndOfPath)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Car::reachedEndOfPath(const QString & _t1)
{
