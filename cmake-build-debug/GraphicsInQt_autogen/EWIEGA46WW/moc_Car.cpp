...
void Car::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->reachedEndOfPath((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Car::*)()>(_a, &Car::carClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Car::*)(const QString & )>(_a, &Car::reachedEndOfPath, 1))
            return;
    }
}
